...
public class MenuViewController implements Initializable {
	...
	/**
	 * Creates statistics menu item
	 */
	private MenuItem createStatisticsMenuItem() {
	...
	/**
	 * Creates info menu item
	 */
	private MenuItem createInfoMenuItem() {
		// Create statistics menu item 
